...
config :roda, RodaWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "WIQB2eNZj9Yw/ksZwfu7wU+VG3+ShpWl1qBBSnnPBl+KszABl2hhL4ZMRZa0gRFc",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:roda, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:roda, ~w(--watch)]}
  ]
...
config :roda, RodaWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/roda_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
